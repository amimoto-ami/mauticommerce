...
function get_woocommerce_country_list() {
	// 'https://raw.githubusercontent.com/woothemes/woocommerce/master/i18n/countries.php'
...
function get_mautic_country_list() {
	$json = file_get_contents( 'https://raw.githubusercontent.com/mautic/mautic/e146b2eb2a2a153c0097e7ab8bdce201fb5f24ce/app/bundles/CoreBundle/Assets/json/countries.json' );
	$array = json_decode($json);
	return $array;
}

$wc_country_list = get_woocommerce_country_list();
$mautic_country_list = get_mautic_country_list();

$null = array();
foreach($wc_country_list as $key => $value ) {
	if( ! in_array( $value,$mautic_country_list  ) ) {
		unset($wc_country_list[$key]);
		$null[$key] = $value;
	}
}

echo "mapped_countries\n";
echo json_encode($wc_country_list). "\n";
echo "\n";
echo "unfined countries\n";
