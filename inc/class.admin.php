...
class Mauticommerce_Admin extends Mauticommerce
{
    ...
    private function _register_admin_panels()
    {
        ...
        add_settings_section(
            ...
            [$this, 'mauticommece_settings_url_section_callback'],
            'MautiCommerce'
        );
        add_settings_field(
            'url',
            __('Mautic URL', self::$text_domain),
            [$this, 'mautic_url_render'],
            'MautiCommerce',
            'mauticommece_RelatedScore_settings'
        );
        add_settings_field(
    ...
    {
        add_options_page('Mauticommece', 'Mauticommece', 'manage_options', 'mauticommece', [$this, 'mauticommece_options']);
    }
}
